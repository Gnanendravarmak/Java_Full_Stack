...
public class MainApplication {
    ...
    private static void handleSavingAccount(SavingAccount account, Scanner scanner) throws Exception {
        boolean back = false;
        while (!back) {
        	 System.out.println("*********************\n");
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    account.changePin(newPin,account.getPin());
                    break;
                case 4:
    ...
    private static void handleCurrentAccount(CurrentAccount account, Scanner scanner) throws Exception {
        boolean back = false;
        while (!back) {
        	 System.out.println("*********************\n");
            System.out.println("1. Withdraw");
